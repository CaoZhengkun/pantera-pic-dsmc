...
USE mpi_common
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ! First define abstract class from which specific VDFs will extend in velocity_distribution.f90
    
   TYPE, ABSTRACT :: VELOCITY_DISTRIBUTION_STRUCTURE

      CONTAINS
      PROCEDURE(SAMPLE_VELOCITY_TYPE), DEFERRED :: SAMPLE_VELOCITY
      PROCEDURE(SAMPLE_NORMAL_TYPE), DEFERRED :: SAMPLE_NORMAL
      PROCEDURE(FLUX_DISTR_TYPE), DEFERRED :: FLUX_DISTR
      PROCEDURE(BETA_TYPE), DEFERRED :: BETA

   END TYPE VELOCITY_DISTRIBUTION_STRUCTURE

   ABSTRACT INTERFACE

      SUBROUTINE SAMPLE_VELOCITY_TYPE(THIS, UX, UY, UZ, TX, TY, TZ, VX, VY, VZ, M)
         IMPORT :: VELOCITY_DISTRIBUTION_STRUCTURE
         CLASS(VELOCITY_DISTRIBUTION_STRUCTURE), INTENT(IN) :: THIS
      ...
      FUNCTION SAMPLE_NORMAL_TYPE(THIS, SN, TINF, M) RESULT(OUT)
         IMPORT :: VELOCITY_DISTRIBUTION_STRUCTURE
         CLASS(VELOCITY_DISTRIBUTION_STRUCTURE), INTENT(IN) :: THIS
      ...
      END FUNCTION SAMPLE_NORMAL_TYPE



      FUNCTION FLUX_DISTR_TYPE(THIS, BETA, S_NORM) RESULT(OUT)
         IMPORT :: VELOCITY_DISTRIBUTION_STRUCTURE
         CLASS(VELOCITY_DISTRIBUTION_STRUCTURE), INTENT(IN) :: THIS
      ...
      END FUNCTION FLUX_DISTR_TYPE


      FUNCTION BETA_TYPE(THIS, TTRA, M) RESULT(OUT)
         IMPORT :: VELOCITY_DISTRIBUTION_STRUCTURE
         CLASS(VELOCITY_DISTRIBUTION_STRUCTURE), INTENT(IN) :: THIS
