...
MODULE global
   ...
   REAL(KIND=8), DIMENSION(4) :: DOMAIN_POTENTIAL = 0.d0
   REAL(KIND=8), DIMENSION(4) :: DOMAIN_RF_AMPLITUDE = 0.d0
   REAL(KIND=8) :: DOMAIN_RF_FREQUENCY = 0.d0
   ...
   LOGICAL      :: CCP1D_DIAGNOSTICS = .FALSE.
   INTEGER      :: CCP1D_DIAGNOSTICS_EVERY = 1
   ...
   REAL(KIND=8), DIMENSION(100) :: CCP_1D_DIAG_FIELD_POWER_SPECIES_SUM = 0.d0
   REAL(KIND=8), DIMENSION(100,2) :: CCP_1D_DIAG_BOUND_NFLUX_IN_SUM = 0.d0
   REAL(KIND=8), DIMENSION(100,2) :: CCP_1D_DIAG_BOUND_EFLUX_IN_SUM = 0.d0
   INTEGER :: CCP_1D_DIAG_SAMPLE_COUNT = 0
