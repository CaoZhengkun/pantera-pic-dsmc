...
MODULE global
   ...
   REAL(KIND=8), DIMENSION(100) :: TURNER_CASE1_DIAG_FIELD_POWER_SPECIES_SUM = 0.d0
   REAL(KIND=8), DIMENSION(100,2) :: TURNER_CASE1_DIAG_BOUND_NFLUX_IN_SUM = 0.d0
   REAL(KIND=8), DIMENSION(100,2) :: TURNER_CASE1_DIAG_BOUND_EFLUX_IN_SUM = 0.d0
   INTEGER :: TURNER_CASE1_DIAG_SAMPLE_COUNT = 0
